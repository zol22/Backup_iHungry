...
<body id="page-top">
  ...
  <!-- Header -->
  <header class="convert d-flex">

    <div class="container text-center my-auto">
      <h1 class="mb-1">Convert Amounts</h1>
      <h3 class="mb-5">
        <em>in a fast way!</em>
      </h3>
  ...
  <div class="container" id="about" >
    ...
    <br>
    <h2 class="text-info">Source<h2><br>
   ...
   <input type="submit" class="btn btn-info" value="submit" name="submit_convert">
  </form>
  </div>
